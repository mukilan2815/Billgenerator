...
export default function DriverSalary1({ data }) {
  return (
    <div id="doc" className="  w-[516px]   ">
      <div
        data-v-7f5c160c=""
        className={`${nunito_sans}  mt-5 container p-[50px] `}
      >
        <div className="flex flex-wrap">
          <div className="w-full  text-right">
            <h6 className=" mb-2  font-medium">Date: {data.rent_date}</h6>
          </div>
        </div>
        <div className="flex flex-wrap">
          <div className="w-full text-center">
            <h6 className=" mb-2">
              <span className="font-bold ">Rent Receipt</span>
            </h6>
          </div>
        </div>
        <div className="flex flex-wrap">
          <div className="w-full  text-justify">
            <p className=" mb-4">
              ...
              paid ₹ <b>{data.rent_amount}</b> to landlord, Mr/Ms{" "}
              <b> {data.landlord_name}</b> towards Rent of the month of{" "}
              <b>{data.bill_month}</b> (Acknowledged receipt enclosed)
            </p>
            <p className=" mb-4">
        ...
        <div className="flex flex-wrap">
          <div className=" w-full">
            <p className=" mb-2">
              <span className=" font-semibold">Date:</span> {data.rent_date}
            </p>
          </div>
