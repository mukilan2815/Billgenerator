...
import DriverSalary3 from "../../previews/Driversalary/DriverSalary3";
import DriverSalary1 from "../../previews/Driversalary/DriverSalary1";
import DriverSalary2 from "../../previews/Driversalary/DriverSalary2";
    ...
    <BillContainer>
      <div className=" grid lg:grid-cols-2  gap-y-5">
        <BillEditContainer finalData={finalData} session={session}>
          ...
          />
          <h2 className=" my-3"> Driver Details</h2>
          <TextInput
            title="Driver Name"
        ...
        <BillViewContainer>
          {finalData.template_data.id == 5 ? (
            <DriverSalary1 data={finalData} />
          ) : finalData.template_data.id == 6 ? (
            <DriverSalary2 data={finalData} />
          ) : finalData.template_data.id == 7 ? (
            <DriverSalary3 data={finalData} />
          ) : (
            ""
          )}
        </BillViewContainer>
